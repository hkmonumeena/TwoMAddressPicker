...
class QuickAddressPicker : AppCompatActivity(), OnMapReadyCallback,GoogleMap.OnCameraMoveListener ,GoogleMap.OnCameraIdleListener {

    companion object {
        private val TAG = QuickAddressPicker::class.java.simpleName
        /**
    ...
    var addressLinezero:String? = null
    ...
    private var mPinList: ArrayList<Pin1>? = null
...
lateinit var activityBindingQuickAddressPicker: ActivityQuickAddressPickerBinding
    public override fun onCreate(savedInstanceState: Bundle?) {

        super.onCreate(savedInstanceState)
        initPlacesApi()
      //  mDefaultLocation =  LatLng(23.000,77.23000)
       activityBindingQuickAddressPicker = DataBindingUtil.setContentView(this,R.layout.activity_quick_address_picker)
        if (intent.hasExtra(ARG_LAT_LNG)) {
            val latLng =
                intent.getSerializableExtra(ARG_LAT_LNG) as MyLatLng1
            mDefaultLocation =
                LatLng(latLng.latitude, latLng.longitude)
        }
        if (intent.hasExtra(ARG_LIST_PIN)) {
            mPinList = intent.getSerializableExtra(ARG_LIST_PIN) as ArrayList<Pin1>
        }
        ...
        activityBindingQuickAddressPicker.btnUseThisLocation.setOnClickListener {
            val intent = Intent()
        ...
        activityBindingQuickAddressPicker.mapLocationButton.setOnClickListener {
    ...
    fun mapInit(googleMap: GoogleMap){
        ...
        googleMap.apply {
         ...
         //   enableMyLocation()
            ...
            setOnCameraMoveListener(this@QuickAddressPicker)
            setOnCameraIdleListener(this@QuickAddressPicker)
           /* if (mapView != null &&
                ...
                val layoutParams = RelativeLayout.LayoutParams(
                    ...
                    RelativeLayout.LayoutParams.MATCH_PARENT)
                mapLocationButton?.setOnClickListener(this@MainActivity)
    ...
    override fun onCameraMove() {
        mMap?.clear()
        activityBindingQuickAddressPicker.imgLocationPinUp?.visibility = View.VISIBLE
    ...
    override fun onCameraIdle() {
        ...
        cameraIdleJob = lifecycleScope.launch {
            delay(750)
            activityBindingQuickAddressPicker.imgLocationPinUp?.visibility = View.GONE
            ...
            getAddress(markerOptions.position.latitude, markerOptions.position.longitude)

            Log.e("dksjdk", "onCameraIdle: "+markerOptions.position.latitude )
...
//                super.onLocationResult(locationResult)
        ...
        when (requestCode) {
            ...
            AUTOCOMPLETE_REQUEST_CODE -> {
                if (resultCode == RESULT_OK) {
                    ...
                    activityBindingQuickAddressPicker.textViewFullAdd?.text = place.address
    ...
    private fun moveMapToLocation(latLng: LatLng) {
        ...
        Log.e("jjhk", "moveMapToLocation: "+latLng)
    }
    ...
    private fun getAddress(latitude: Double, longitude: Double): String? {
        ...
        try {
            ...
            if (addresses.size > 0) {
                ...
                addressLinezero = addresses[0].getAddressLine(0) // If any additional address line present than only, check with max available address lines by getMaxAddressLineIndex()
                ...
                activityBindingQuickAddressPicker.textViewFullAdd?.text = """${addressLinezero}, ${city}, ${knownName}, ${state}, ${country}"""
                activityBindingQuickAddressPicker.textViewCityName?.text = """$city"""
                activityBindingQuickAddressPicker.textViewPostalCode?.text = """$postalCode"""
    ...
    private fun setMarkerOnTheMap(latitude: String, logitude: String){
        ...
        mMap?.animateCamera(CameraUpdateFactory.newLatLngZoom(klcc, 10f))
    }
...
class MyLatLng1(var latitude: Double, var longitude: Double) : Serializable
class Pin1(var latLng:MyLatLng1, var title: String?) : Serializable